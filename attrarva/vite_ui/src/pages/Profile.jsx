...
export default function Profile() {
    ...
    const statCards = [
        ...
        { label: 'Current Streak', value: `${stats.streak} Days`, icon: Target, color: 'bg-gradient-to-br from-orange-400 to-amber-500', iconBg: 'bg-orange-50', iconColor: 'text-orange-500' },
        { label: 'Games Won', value: `${stats.games_won} / ${stats.games_played}`, icon: Award, color: 'bg-gradient-to-br from-emerald-500 to-green-400', iconBg: 'bg-green-50', iconColor: 'text-green-500' },
    ];
